...
window[_0x3b397b(0x152)](_0x3b397b(0x4e1), function() {
    ...
    $('#markup-footer') // Footer kÄ±smÄ±na iÃ§erik ekleniyor.
        .html('<footer id="markup-footer"><div class="lang-menu"><button class="lang-button">Language </button><div class="lang-list"><a hreflang="en" href="/">English</a><a hreflang="de" href="/de/">Deutsch</a><a hreflang="fr" href="/fr/">FranÃ§ais</a><a hreflang="es" href="/es/">EspaÃ±ol</a></div></div><a class="link" hreflang="en" href="https://wormate.io/">WormBMW 2026</a><a style="font-size:17px;font-weight:600;">3bso<a style="font-size:17px;font-weight:500;color:#ff0;"> Ext Worm <i class="fa fa-heart animated infinite pulse" style="color:red"></i> BMW !</a></footer>');
